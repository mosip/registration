 ...
 */
@Service
public class RegistrationProcessorWebClientServiceImpl implements RegistrationProcessorWebClientService<Object> {

    /** The logger. */
    private static Logger regProcLogger = RegProcessorLogger
            .getLogger(RegistrationProcessorWebClientServiceImpl.class);
    ...
    private boolean checkNull(String queryParamName) {
        return ((queryParamName == null) || (queryParamName.isEmpty()));
    }
