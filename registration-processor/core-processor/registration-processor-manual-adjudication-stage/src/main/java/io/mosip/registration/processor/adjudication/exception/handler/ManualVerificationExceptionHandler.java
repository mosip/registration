package io.mosip.registration.processor.adjudication.exception.handler;

import java.util.List;
import java.util.Objects;
import java.util.stream.Collectors;

import io.mosip.registration.processor.adjudication.exception.FileNotFoundInFileStoreException;
import io.mosip.registration.processor.adjudication.exception.FileNotPresentException;
import io.mosip.registration.processor.adjudication.exception.InvalidFieldsException;
