package io.mosip.registration.processor.verification.exception.handler;
...
import io.mosip.registration.processor.verification.exception.FileNotFoundInFileStoreException;
import io.mosip.registration.processor.verification.exception.FileNotPresentException;
import io.mosip.registration.processor.verification.exception.InvalidFieldsException;
import io.mosip.registration.processor.verification.exception.InvalidFileNameException;
import io.mosip.registration.processor.verification.exception.InvalidTokenHandlerException;
import io.mosip.registration.processor.verification.exception.InvalidUpdateException;
