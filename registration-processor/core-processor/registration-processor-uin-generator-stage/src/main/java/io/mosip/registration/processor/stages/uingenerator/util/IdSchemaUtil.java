...
public class IdSchemaUtil {
    ...
    public Map<String, List<Object>> loadSchemaFields(Double schemaVersion) throws JSONException, ApisResourceAccessException {
    ...
    private String getIdSchema(Double version) throws ApisResourceAccessException, JSONException {
        ...
        String response = (String) registrationProcessorRestClientService.getApi(
                ApiName.IDSCHEMAURL, null, "schemaVersion", String.valueOf(version), String.class);
