...
public enum StatusUtil {
	...
	TIMESTAMP_AFTER_PACKETTIME(StatusConstants.CMD_VALIDAOR_MODULE_FAILED + "016"  ,"digital id timestamp is %s minutes after packet creation time"),
	TIMESTAMP_BEFORE_PACKETTIME(StatusConstants.CMD_VALIDAOR_MODULE_FAILED + "017"  ,"digital id timestamp is %s minutes before packet creation time"),
	DEVICE_HOTLISTED(StatusConstants.CMD_VALIDAOR_MODULE_FAILED + "018"  ,"Device has been hot listed"),
	DEVICE_SIGNATURE_VALIDATION_FAILED(StatusConstants.CMD_VALIDAOR_MODULE_FAILED + "019", "DigitalId signature Validation Failed"),
