...
public enum PlatformErrorMessages {
	...
	RPR_WIA_SUBWORKFLOW_CANNOT_REQUEST(PlatformConstants.RPR_WORKFLOW_INTERNAL_ACTION + "004",
			"SubWorkflow cannot be  PauseAndRequestAdditionalInfo so it is failed"),
