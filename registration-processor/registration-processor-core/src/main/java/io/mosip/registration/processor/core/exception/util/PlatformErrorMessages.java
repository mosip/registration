...
public enum PlatformErrorMessages {
	...
	RPR_CDS_UIN_ALREADY_ACTIVATED(PlatformConstants.RPR_CREATE_DRAFT_STAGE + "004",
			"UIN is already Activated"),
	RPR_CDS_UIN_ALREADY_DEACTIVATED(PlatformConstants.RPR_CREATE_DRAFT_STAGE + "005",
			"UIN already deactivated"),
	RPR_CDS_UIN_ACTIVATION_FAILED(PlatformConstants.RPR_CREATE_DRAFT_STAGE + "006",
			"UIN Activation Failed"),
	RPR_CDS_UIN_REACTIVATION_FAILED(PlatformConstants.RPR_CREATE_DRAFT_STAGE + "007",
	...
	RPR_CDS_ID_REPO_ACCESS_FAILED(PlatformConstants.RPR_CREATE_DRAFT_STAGE + "009",
			"ID Repo access failed in create draft stage"),
	RPR_CDS_LINK_RID_FOR_LOST_PACKET_FAILED(PlatformConstants.RPR_CREATE_DRAFT_STAGE + "010",
			"RID Not Linked for Lost Packet in create draft stage"),
