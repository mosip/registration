...
public class MessageBusAddress implements Serializable {
	...
	public static final MessageBusAddress PRINTING_BUS_IN = new MessageBusAddress("credential-requestor-bus-in");

	/** The Constant PRINTING_BUS_OUT. */
	public static final MessageBusAddress PRINTING_BUS_OUT = new MessageBusAddress("credential-requestor-bus-out");
