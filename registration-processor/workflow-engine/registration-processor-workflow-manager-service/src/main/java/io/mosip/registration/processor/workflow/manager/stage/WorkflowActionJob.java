...
import io.mosip.registration.processor.workflow.manager.constants.WorkflowManagerConstants;
...
public class WorkflowActionJob extends MosipVerticleAPIManager {
	...
	/** The fetch size. */
	@Value("${registration.processor.workflow-manager.action.job.fetchsize}")
	private Integer fetchSize;

	/** The elapse time. */
	@Value("${registration.processor.workflow-manager.action.job.elapse.time}")
