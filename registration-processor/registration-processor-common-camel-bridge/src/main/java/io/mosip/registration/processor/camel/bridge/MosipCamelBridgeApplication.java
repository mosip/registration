...
public class MosipCamelBridgeApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		configApplicationContext.scan("io.mosip.registration.processor.core.config","io.mosip.registration.processor.camel.bridge.config","io.mosip.registration.processor.rest.client.config","io.mosip.registration.processor.camel.bridge.intercepter");
