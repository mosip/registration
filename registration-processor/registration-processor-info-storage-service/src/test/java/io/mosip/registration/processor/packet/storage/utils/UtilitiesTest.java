...
//        idVidMetadataDto.setUpdatedOn("2024-01-01T12:00:00");
...
//
//    @Test
//    public void testWasInfantWhenLastPacketProcessed_Success_idvid1() throws Exception {
//        // Directly populate the mappingJsonObject with the necessary data
//        JSONObject mappingJsonObject = new JSONObject();
//
//        // Create identity part directly with mapping keys and values
//        JSONObject identityJson = new JSONObject();
//        identityJson.put("dob", new JSONObject().put("value", "dateOfBirth"));
//        identityJson.put("packetCreatedOn", new JSONObject().put("value", "packetCreatedOn"));
//
//        // Insert the identity JSON into the main mapping JSON
//        mappingJsonObject.put("identity", identityJson);
//
//        // Use ReflectionTestUtils to inject mappingJsonObject into the utilities object
//        ReflectionTestUtils.setField(utilities, "mappingJsonObject", mappingJsonObject);
//
...
//        String packetCreatedDate = "2025-04-30T07:04:49.681Z";
//
//        // Mock the behavior of packetManagerService
//        Mockito.when(packetManagerService.getFieldByMappingJsonKey(anyString(), anyString(), anyString(), any(ProviderStageName.class)))
//                .thenReturn(uin);
//
//        // Prepare the response map for identityJson
//        Map<String, String> response = new HashMap<>();
//        response.put("dateOfBirth", dob);
//        response.put("packetCreatedOn", packetCreatedDate);
//
//        // Convert the response map to a JSON string and then to a JSONObject
//        String jsonString = new ObjectMapper().writeValueAsString(response);
//        JSONObject identityJsonMock = new JSONObject();
//
//        // Mock the behavior of idRepoService to return the identityJson
//        Mockito.when(idRepoService.getIdJsonFromIDRepo(anyString(), any())).thenReturn(identityJsonMock);
//
...
//        idVidMetadataDto.setUpdatedOn("2025-09-26T11:09:22.477Z");
//
//        when(idRepoService.searchIdVidMetadata(anyString())).thenReturn(idVidMetadataDto);
//
//        SyncRegistrationEntity syncRegistration = new SyncRegistrationEntity();
...
////
////    @Test
////    public void testComputePacketCreatedFromIdentityUpdate_NormalCase() {
////        // Given update timestamp in expected format
////        IdVidMetadataDTO idVidMetadataDTO = new IdVidMetadataDTO();
////        idVidMetadataDTO.setUpd_dtimes("2025-09-30T08:42:27.326Z");
////        idVidMetadataDTO.setRid("RID456");
////
////        // When
////        LocalDateTime result = utilities.computePacketCreatedFromIdentityUpdate(idVidMetadataDTO);
////        assertNotNull(result);
////
////    }
////
