...
//        when(idRepoService.searchIdVidMetadata(anyString())).thenReturn(ridDto1);
...
//        when(packetManagerService.getField(anyString(), anyString(), anyString(), any(ProviderStageName.class)))
//                .thenReturn(uin);
//        when(idRepoService.searchIdVidMetadata(uin)).thenReturn(ridDto);
//
//        // Execute
...
//
//        // Execute
//        Date result = utilities.getPacketCreatedDateFromSyncRegistration(ridDto.getRid());
//
//        // Verify
