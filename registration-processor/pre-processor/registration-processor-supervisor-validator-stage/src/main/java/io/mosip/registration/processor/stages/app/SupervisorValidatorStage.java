...
@ComponentScan(basePackages = { "io.mosip.registration.processor.core.config",
		...
		"io.mosip.registration.processor.core.kernel.beans", "io.mosip.registration.processor.stages.supervisor" })
public class SupervisorValidatorStage extends MosipVerticleAPIManager {
	...
	public void deployVerticle() {
		...
		this.consumeAndSend(mosipEventBus, MessageBusAddress.SUPERVISOR_BUS_IN, MessageBusAddress.SUPERVISOR_BUS_OUT,
	...
	public void start() {
		router.setRoute(
				this.postUrl(getVertx(), MessageBusAddress.SUPERVISOR_BUS_IN, MessageBusAddress.SUPERVISOR_BUS_OUT));
