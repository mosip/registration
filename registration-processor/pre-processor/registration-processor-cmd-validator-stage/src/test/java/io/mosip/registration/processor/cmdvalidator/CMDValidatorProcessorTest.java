...
public class CMDValidatorProcessorTest {
	...
	public void setUp() throws Exception {
		...
		ReflectionTestUtils.setField(cmdValidationProcessor, "validateRegistrationCenterforSubProcess", true);
		...
		ReflectionTestUtils.setField(cmdValidationProcessor, "subProcesses", "CORRECTION,BIO-CORRECTION,UPDATE,LOST");
