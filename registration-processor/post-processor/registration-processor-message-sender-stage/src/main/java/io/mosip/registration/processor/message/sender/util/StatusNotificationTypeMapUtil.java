...
public class StatusNotificationTypeMapUtil {
	...
	private static Map<NotificationStageStatus, NotificationTemplateType> statusMapper() {
		...
		statusMap.put(NotificationStageStatus.INTRODUCER_VALIDATION_FAILED, NotificationTemplateType.TECHNICAL_ISSUE);
		...
		statusMap.put(NotificationStageStatus.INTRODUCER_VALIDATION_ERROR, NotificationTemplateType.TECHNICAL_ISSUE);
