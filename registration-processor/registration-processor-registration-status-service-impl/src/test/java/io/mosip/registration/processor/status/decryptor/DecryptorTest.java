...
public class DecryptorTest {
	...
	public void setup() throws IOException {
		...
		when(mapper.writeValueAsString(any())).thenReturn("decrypted str");
	...
	public void HttpServerErrorExceptionTest()
		...
		errors.add(new ErrorDTO("HttpStatus.INTERNAL_SERVER_ERROR",
				"KER-FSE-004:encrypted data is corrupted or not base64 encoded"));
	...
	public void PacketDecryptionFailureExceptionTest()
		...
		ApisResourceAccessException apisResourceAccessException =
				new ApisResourceAccessException("Packet Decryption failure");
