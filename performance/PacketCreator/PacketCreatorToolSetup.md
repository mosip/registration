...
The script *`PacketCreator_and_Upload_Test_Script.jmx`* uses this tool to generate new packets that can later be synced and uploaded via Registration Processor APIs.

This document guides users through the installation and setup of the Packet Creator tool for the use of  *`PacketCreator_and_Upload_Test_Script.jmx`* script.
...
dslrig-packetcreator-1.2.0.1.jar
...
2. Place the dslrig-packetcreator-1.2.0.1.jar in the same new path.
