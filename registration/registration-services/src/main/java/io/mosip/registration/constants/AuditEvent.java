...
public enum AuditEvent {
	...
	NAV_RE_REGISTRATION("REG-EVT-006", SYSTEM_EVENT.getCode(), "NAV_RE_REGISTRATION", "Navigation link: Re-Registration"),
	...
	REG_DEMO_NEXT("REG-EVT-009", USER_EVENT.getCode(), "REG_DEMO_NEXT", "Click of Next after capturing demographic details"),
	...
	REG_BIO_EXCEPTION_NEXT("REG-EVT-028", USER_EVENT.getCode(), "REG_BIO_EXCEPTION_NEXT", "Click of Next after marking exceptions"),
	REG_BIO_EXCEPTION_BACK("REG-EVT-029", USER_EVENT.getCode(), "REG_BIO_EXCEPTION_BACK", "Click of Back from biometric exception capture screen"),
	REG_BIO_LEFT_SLAP_SCAN("REG-EVT-030", USER_EVENT.getCode(), "REG_BIO_LEFT_SLAP_SCAN", "Fingerprints: Scan of left slap"),
	REG_BIO_RIGHT_SLAP_SCAN("REG-EVT-031", USER_EVENT.getCode(), "REG_BIO_RIGHT_SLAP_SCAN", "Fingerprints: Scan of right slap"),
	REG_BIO_THUMBS_SCAN("REG-EVT-032", USER_EVENT.getCode(), "REG_BIO_THUMBS_SCAN", "Fingerprints: Scan of thumbs"),
	REG_BIO_FINGERPRINT_BACK("REG-EVT-033", USER_EVENT.getCode(), "REG_BIO_FINGERPRINT_BACK", "Click of Back from fingerprint capture screen"),
	...
	REG_BIO_IRIS_BACK("REG-EVT-038", USER_EVENT.getCode(), "REG_BIO_IRIS_BACK", "Click of Back from iris capture screen"),
	REG_BIO_FACE_CAPTURE("REG-EVT-039", USER_EVENT.getCode(), "REG_BIO_FACE_CAPTURE", "Photo: Face capture"),
	REG_BIO_EXCEP_FACE_CAPTURE("REG-EVT-040", USER_EVENT.getCode(), "REG_BIO_EXCEPION_FACE_CAPTURE", "Photo: Exception face capture"),
	REG_BIO_CAPTURE_NEXT("REG-EVT-041", USER_EVENT.getCode(), "REG_BIO_CAPTURE_NEXT", "Click of Next after capturing Biometrics"),
	REG_BIO_FACE_CAPTURE_BACK("REG-EVT-042", USER_EVENT.getCode(), "REG_BIO_FACE_CAPTURE_BACK", "Click of Back from face photo capture screen"),
	...
	REG_PREVIEW_SUBMIT("REG-EVT-046", USER_EVENT.getCode(), "REG_PREVIEW_SUBMIT", "Click of Next after Registration Preview"),
	...
	REG_OPERATOR_AUTH_GET_OTP("REG-EVT-049", USER_EVENT.getCode(), "REG_OPERATOR_AUTH_GET_OTP", "Operator authentication with OTP: Get OTP"),
	REG_OPERATOR_AUTH_SUBMIT_OTP("REG-EVT-050", USER_EVENT.getCode(), "REG_OPERATOR_AUTH_SUBMIT_OTP", "Operator authentication with OTP: Submit OTP"),
	REG_OPERATOR_AUTH_RESEND_OTP("REG-EVT-051", USER_EVENT.getCode(), "REG_OPERATOR_AUTH_RESEND_OTP", "Operator authentication with OTP: Resend OTP"),
	REG_OPERATOR_AUTH_FINGERPRINT("REG-EVT-052", USER_EVENT.getCode(), "REG_OPERATOR_AUTH_FINGERPRINT", "Operator authentication with fingerprint: Capture and submit"),
	REG_OPERATOR_AUTH_IRIS("REG-EVT-053", USER_EVENT.getCode(), "REG_OPERATOR_AUTH_IRIS", "Operator authentication with iris: Capture and submit"),
	REG_OPERATOR_AUTH_FACE("REG-EVT-054", USER_EVENT.getCode(), "REG_OPERATOR_AUTH_FACE", "Operator authentication with face: Capture and submit"),
	...
	REG_SUPERVISOR_AUTH_PASSWORD("REG-EVT-057", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_PASSWORD", "Supervisor authentication with password: Click of Submit"),
	REG_SUPERVISOR_AUTH_GET_OTP("REG-EVT-058", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_GET_OTP", "Supervisor authentication with OTP: Get OTP"),
	REG_SUPERVISOR_AUTH_SUBMIT_OTP("REG-EVT-059", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_SUBMIT_OTP", "Supervisor authentication with OTP: Submit OTP"),
	REG_SUPERVISOR_AUTH_RESEND_OTP("REG-EVT-060", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_RESEND_OTP", "Supervisor authentication with OTP: Resend OTP"),
	REG_SUPERVISOR_AUTH_FINGERPRINT("REG-EVT-061", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_FINGERPRINT", "Supervisor authentication with fingerprint: Capture and submit"),
	REG_SUPERVISOR_AUTH_IRIS("REG-EVT-062", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_IRIS", "Supervisor authentication with iris: Capture and submit"),
	REG_SUPERVISOR_AUTH_FACE("REG-EVT-063", USER_EVENT.getCode(), "REG_SUPERVISOR_AUTH_FACE", "Supervisor authentication with face: Capture and submit"),
