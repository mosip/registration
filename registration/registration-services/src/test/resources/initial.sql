...
CREATE TABLE "REG"."REGISTERED_DEVICE_MASTER" ("CODE" VARCHAR(36) NOT NULL, "DTYPE_CODE" VARCHAR(36) NOT NULL, "DSTYPE_CODE" VARCHAR(36) NOT NULL, "STATUS_CODE" VARCHAR(64), "DEVICE_ID" VARCHAR(256) NOT NULL, "DEVICE_SUB_ID" VARCHAR(256), "DIGITAL_ID" VARCHAR(1024) NOT NULL, "SERIAL_NUMBER" VARCHAR(64) NOT NULL, "PROVIDER_ID" VARCHAR(36) NOT NULL, "PROVIDER_NAME" VARCHAR(128), "PURPOSE" VARCHAR(64) NOT NULL, "FIRMWARE" VARCHAR(128), "MAKE" VARCHAR(36) NOT NULL, "MODEL" VARCHAR(36) NOT NULL, "EXPIRY_DATE" TIMESTAMP, "CERTIFICATION_LEVEL" VARCHAR(3), "FOUNDATIONAL_TRUST_PROVIDER_ID" VARCHAR(36), "FOUNDATIONAL_TRUST_SIGNATURE" VARCHAR(512), "FOUNDATIONAL_TRUST_CERTIFICATE" BLOB(2147483647), "DPROVIDER_SIGNATURE" VARCHAR(512), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
ALTER TABLE "REG"."REGISTERED_DEVICE_MASTER" ADD CONSTRAINT "PK_REGDEVICEM_CODE" PRIMARY KEY ("CODE");

ALTER TABLE "REG"."REGISTERED_DEVICE_MASTER" ADD CONSTRAINT "UK_REGDEVM_ID" UNIQUE ("SERIAL_NUMBER", "PROVIDER_ID");
