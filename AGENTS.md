...
When metaInfo attributes are needed, read them from the `registration_list` columns (`packet_meta_data`, `packet_operations_data`, `packet_captured_devices`) rather than calling Packet Manager.
