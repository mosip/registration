...
-- Sept-2021  Chandra Keshav Mishra   Updated changes for transaction typr table.
----------------------------------------------------------------------------------------------------
...
INSERT INTO regprc.transaction_type(code, descr, lang_code, is_active, cr_by, cr_dtimes, upd_by, upd_dtimes, is_deleted, del_dtimes) VALUES ('PACKET_CLASSIFICATION', 'transcation done', 'eng',true,'MOSIP_SYSTEM', now(), null, null, null, null, null);
