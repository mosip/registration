...
## Each release database folder has the following files and folders
...
**Step 2** -> DB Release deployment for all databases, run the **"regprc_release_db_deploy.sh"** script with release version as parameter.  To access and exeute **"regprc_release_db_deploy.sh"** script, follow the below given sample commands:

<em> **Enter:-bash-4.2$** cd /home/madmin/database_release/mosip_regprc </em>

<em> **Enter:-bash-4.2$** bash regprc_release_db_deploy.sh  regprc_release_deploy.properties <release_version_number> </em>
...
**Step 1** -> DB Revoke deployment for all databases, run the **"regprc_revoke_db_deploy.sh"** script with release version as parameter.  To access and exeute **"regprc_revoke_db_deploy.sh "** script, follow the below given commands:

<em> **Enter:-bash-4.2$** cd /home/madmin/database_release/mosip_regprc </em>

<em> **Enter:-bash-4.2$** bash regprc_revoke_db_deploy.sh regprc_release_deploy.properties <release_version_number> </em>
